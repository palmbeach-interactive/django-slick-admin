...
@register.inclusion_tag(
    "django_slick_admin/templatetags/cms_styles.html", takes_context=True
)
def slick_admin_cms_style(context):
    ...
    if (
        ...
        and "cms_toolbar_disabled" in request.session
        and not request.session["cms_toolbar_disabled"]
    ):
